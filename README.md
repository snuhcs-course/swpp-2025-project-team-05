...
https://drive.google.com/file/d/1CybQh7Tu8majc1HfCWTo9RIZfzc5nwcH/view?usp=sharing
...
- [ ] Properly working voting and veto
- [ ] Push notifications for poll start/end
- [ ] In-app messaging for team coordination
- [ ] Restaurant integration with location data
- [ ] Historical poll analytics
- [ ] Custom food item suggestions
- [ ] Dietary preference learning from vote history
- [ ] Allergen detection from menu photos (ML vision)
